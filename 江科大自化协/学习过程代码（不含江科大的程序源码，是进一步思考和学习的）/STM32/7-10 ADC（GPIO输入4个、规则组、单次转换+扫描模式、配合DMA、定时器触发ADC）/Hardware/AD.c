...
void AD_Init(void)
{
    ...
    */
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_2, 3, ADC_SampleTime_55Cycles5);	//规则组序列1的位置，配置为通道ADC1_IN2，对应PA2
	ADC_RegularChannelConfig(ADC1, ADC_Channel_3, 4, ADC_SampleTime_55Cycles5);	//规则组序列2的位置，配置为通道ADC1_IN3，对应PA3
	/*
